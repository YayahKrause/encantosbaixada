...
(function($) {
  ...
  Menu.prototype.generateMore = function() {
    ...
    $('.menu-more').toggleClass('flyout-right', (window.innerWidth - $('.desktop-nav .site-menu-default .site-menu-item-wrap').last().offset().left < 400));
  };
  ...
  $.fn[pluginName] = function(options) {
    // Defaults
    settings = $.extend({
      parentClass: 'site-menu-item-wrap',
      parentLinkClass: 'site-menu-item',
      containerClass: 'site-menu-wrap',
      listClass: 'site-menu',
      childClass: 'site-menu-subitem-wrap',
      childLinkClass: 'site-menu-subitem',
      moreLinkHtml: 'More',
    }, options );
